...
- Node.js is a JavaScript runtime that allows you to run JavaScript code outside of a browser. Node.js is useful because it allows you to do things with JavaScript that were only before possible with languages like C++, Java, C#, etc. Express is a server side routing framework that is used to build web APIs and web servers. Express is useful because it abstracts a lot of the work when building out a web server so the programmer only has to focus on the important details.

1. Understand and explain the use of Middleware.

- Middleware is used to further extend the functionality of Express. Middleware can do lots of things but is commonly used to validate the request body, and request parameters that are sent to an endpoint. Middleware can also be used to log requests and to provide security to routes in an application.

1. The basic principles of the REST architectural style.

- REST stands for REpresentational State Transfer, REST allows for creation and manipulation of resources.

1. Understand and explain the use of Express Routers.

- Express routers are used to separate groups of routes into different files in order to keep the code coherent and organized.

1. Describe tooling used to manually test the correctness of an API.

- Some tooling used to manually test the correctness of an API are tools like Postman and Insomnia. Postman and Insomnia are tools that allow us to send all kinds of requests to an API and get a response back, Postmand and Insomnia also allow for the use of headers and body in the request.
